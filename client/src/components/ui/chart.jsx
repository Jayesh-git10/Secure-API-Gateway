...
const ChartContainer = /*#__PURE__*/React.forwardRef(
  ...
  ({ id, className, children, config, ...props }, ref) => {
    ...
    return (/*#__PURE__*/
      React.createElement(ChartContext.Provider, { value: { config } }, /*#__PURE__*/
      ...
      React.createElement(ChartStyle, { id: chartId, config: config }), /*#__PURE__*/
      React.createElement(RechartsPrimitive.ResponsiveContainer, null,
      children
      )
      )
      ));
...
const ChartTooltipContent = /*#__PURE__*/React.forwardRef(
  ...
  ref) =>
  {
    ...
    return (/*#__PURE__*/
      ...
      !nestLabel ? tooltipLabel : null, /*#__PURE__*/
      ...
      payload.map((item, index) => {
        ...
        return (/*#__PURE__*/
          ...
          formatter(item.value, item.name, item, index, item.payload) : /*#__PURE__*/

          React.createElement(React.Fragment, null,
          itemConfig?.icon ? /*#__PURE__*/
          React.createElement(itemConfig.icon, null) :
    ...
    return (/*#__PURE__*/
      ...
      payload.map((item) => {
        ...
        return (/*#__PURE__*/
          ...
          React.createElement(itemConfig.icon, null) : /*#__PURE__*/
