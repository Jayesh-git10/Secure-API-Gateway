...

{
  ...
  return (/*#__PURE__*/
    React.createElement(FormFieldContext.Provider, { value: { name: props.name } }, /*#__PURE__*/
...
const FormItem = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, ...props }, ref) => {
    ...
    return (/*#__PURE__*/
      React.createElement(FormItemContext.Provider, { value: { id } }, /*#__PURE__*/
      React.createElement("div", _extends({ ref: ref, className: cn("space-y-2", className) }, props))
      ));
