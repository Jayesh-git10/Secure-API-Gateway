...
React.createElement(ResizablePrimitive.PanelGroup, _extends({
  className: cn(
...
React.createElement(ResizablePrimitive.PanelResizeHandle, _extends({
  className: cn(
...
withHandle && /*#__PURE__*/
React.createElement("div", { className: "z-10 flex h-4 w-3 items-center justify-center rounded-sm border bg-border" }, /*#__PURE__*/
