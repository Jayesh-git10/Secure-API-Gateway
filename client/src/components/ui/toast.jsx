...
const ToastViewport = /*#__PURE__*/React.forwardRef(
  ...
  React.createElement(ToastPrimitives.Viewport, _extends({
    ref: ref,
    className: cn(
...
const Toast = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, variant, ...props }, ref) => {
    return (/*#__PURE__*/
      React.createElement(ToastPrimitives.Root, _extends({
        ref: ref,
...
const ToastAction = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, ...props }, ref) => /*#__PURE__*/
  React.createElement(ToastPrimitives.Action, _extends({
    ref: ref,
    className: cn(
...
const ToastClose = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, ...props }, ref) => /*#__PURE__*/
  React.createElement(ToastPrimitives.Close, _extends({
    ref: ref,
    className: cn(
...
const ToastTitle = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, ...props }, ref) => /*#__PURE__*/
  React.createElement(ToastPrimitives.Title, _extends({
    ref: ref,
...
const ToastDescription = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, ...props }, ref) => /*#__PURE__*/
  React.createElement(ToastPrimitives.Description, _extends({
    ref: ref,
