...
function MenubarSub({
  ...
  return /*#__PURE__*/React.createElement(MenubarPrimitive.Sub, _extends({ "data-slot": "menubar-sub" }, props));
}
...
const Menubar = /*#__PURE__*/React.forwardRef(
  ...
  React.createElement(MenubarPrimitive.Root, _extends({
    ref: ref,
    className: cn(
...
const MenubarTrigger = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, ...props }, ref) => /*#__PURE__*/
  React.createElement(MenubarPrimitive.Trigger, _extends({
    ref: ref,
    className: cn(
...
const MenubarSubTrigger = /*#__PURE__*/React.forwardRef(
  ...
  React.createElement(MenubarPrimitive.SubTrigger, _extends({
    ref: ref,
    className: cn(
...
const MenubarSubContent = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, ...props }, ref) => /*#__PURE__*/
  React.createElement(MenubarPrimitive.SubContent, _extends({
    ref: ref,
    className: cn(
...
const MenubarContent = /*#__PURE__*/React.forwardRef(
  ...
  React.createElement(MenubarPrimitive.Portal, null, /*#__PURE__*/
  React.createElement(MenubarPrimitive.Content, _extends({
    ref: ref,
    align: align,
...
const MenubarItem = /*#__PURE__*/React.forwardRef(
  ...
  React.createElement(MenubarPrimitive.Item, _extends({
    ref: ref,
    className: cn(
...
const MenubarCheckboxItem = /*#__PURE__*/React.forwardRef(
  ...
  React.createElement(MenubarPrimitive.CheckboxItem, _extends({
    ref: ref,
    className: cn(
  ...
  React.createElement("span", { className: "absolute left-2 flex h-3.5 w-3.5 items-center justify-center" }, /*#__PURE__*/
  React.createElement(MenubarPrimitive.ItemIndicator, null, /*#__PURE__*/
...
const MenubarRadioItem = /*#__PURE__*/React.forwardRef(
  ...
  React.createElement(MenubarPrimitive.RadioItem, _extends({
    ref: ref,
    className: cn(
      "relative flex cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      className
...
const MenubarLabel = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, inset, ...props }, ref) => /*#__PURE__*/
  React.createElement(MenubarPrimitive.Label, _extends({
    ref: ref,
    className: cn(
...
const MenubarSeparator = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, ...props }, ref) => /*#__PURE__*/
  React.createElement(MenubarPrimitive.Separator, _extends({
    ref: ref,
