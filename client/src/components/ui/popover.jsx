...
const PopoverContent = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, align = "center", sideOffset = 4, ...props }, ref) => /*#__PURE__*/
  React.createElement(PopoverPrimitive.Portal, null, /*#__PURE__*/
  React.createElement(PopoverPrimitive.Content, _extends({
    ref: ref,
    align: align,
