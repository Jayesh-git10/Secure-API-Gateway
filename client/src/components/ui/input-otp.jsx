...
const InputOTP = /*#__PURE__*/React.forwardRef(
  ...
  React.createElement(OTPInput, _extends({
    ref: ref,
...
const InputOTPGroup = /*#__PURE__*/React.forwardRef(
  ...
  React.createElement("div", _extends({ ref: ref, className: cn("flex items-center", className) }, props))
);
...
const InputOTPSlot = /*#__PURE__*/React.forwardRef(
  ...
  ({ index, className, ...props }, ref) => {
    ...
    return (/*#__PURE__*/
      ...
      React.createElement("div", { className: "pointer-events-none absolute inset-0 flex items-center justify-center" }, /*#__PURE__*/
...
const InputOTPSeparator = /*#__PURE__*/React.forwardRef(
  ...
  ({ ...props }, ref) => /*#__PURE__*/
  React.createElement("div", _extends({ ref: ref, role: "separator" }, props), /*#__PURE__*/
