...
const SelectTrigger = /*#__PURE__*/React.forwardRef(
  ...
  React.createElement(SelectPrimitive.Trigger, _extends({
    ref: ref,
    className: cn(
  ...
  children, /*#__PURE__*/
  React.createElement(SelectPrimitive.Icon, { asChild: true }, /*#__PURE__*/
...
const SelectScrollUpButton = /*#__PURE__*/React.forwardRef(
  ...
  React.createElement(SelectPrimitive.ScrollUpButton, _extends({
    ref: ref,
    className: cn(
...
const SelectScrollDownButton = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, ...props }, ref) => /*#__PURE__*/
  React.createElement(SelectPrimitive.ScrollDownButton, _extends({
    ref: ref,
    className: cn(
      "flex cursor-default items-center justify-center py-1",
      className
...
const SelectContent = /*#__PURE__*/React.forwardRef(
  ...
  React.createElement(SelectPrimitive.Portal, null, /*#__PURE__*/
  React.createElement(SelectPrimitive.Content, _extends({
    ref: ref,
    className: cn(
  ...
  React.createElement(SelectScrollUpButton, null), /*#__PURE__*/
...
const SelectLabel = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, ...props }, ref) => /*#__PURE__*/
  React.createElement(SelectPrimitive.Label, _extends({
    ref: ref,
...
const SelectItem = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, children, ...props }, ref) => /*#__PURE__*/
  React.createElement(SelectPrimitive.Item, _extends({
    ref: ref,
    className: cn(
  ...
  React.createElement(SelectPrimitive.ItemIndicator, null, /*#__PURE__*/
...
const SelectSeparator = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, ...props }, ref) => /*#__PURE__*/
  React.createElement(SelectPrimitive.Separator, _extends({
    ref: ref,
