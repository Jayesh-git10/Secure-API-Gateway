...
const PaginationItem = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, ...props }, ref) => /*#__PURE__*/
  React.createElement("li", _extends({ ref: ref, className: cn("", className) }, props))
);
...
React.createElement(ChevronLeft, { className: "h-4 w-4" }), /*#__PURE__*/
...
React.createElement("span", null, "Next"), /*#__PURE__*/
...
React.createElement(MoreHorizontal, { className: "h-4 w-4" }), /*#__PURE__*/
