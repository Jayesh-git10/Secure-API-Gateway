...
const ContextMenuSubTrigger = /*#__PURE__*/React.forwardRef(
  ...
  React.createElement(ContextMenuPrimitive.SubTrigger, _extends({
    ref: ref,
    className: cn(
...
const ContextMenuSubContent = /*#__PURE__*/React.forwardRef(
  ...
  React.createElement(ContextMenuPrimitive.SubContent, _extends({
    ref: ref,
    className: cn(
...
const ContextMenuContent = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, ...props }, ref) => /*#__PURE__*/
  React.createElement(ContextMenuPrimitive.Portal, null, /*#__PURE__*/
  React.createElement(ContextMenuPrimitive.Content, _extends({
    ref: ref,
    className: cn(
...
const ContextMenuItem = /*#__PURE__*/React.forwardRef(
  ...
  React.createElement(ContextMenuPrimitive.Item, _extends({
    ref: ref,
    className: cn(
...
const ContextMenuCheckboxItem = /*#__PURE__*/React.forwardRef(
  ...
  React.createElement(ContextMenuPrimitive.CheckboxItem, _extends({
    ref: ref,
    className: cn(
  ...
  React.createElement(ContextMenuPrimitive.ItemIndicator, null, /*#__PURE__*/
...
const ContextMenuRadioItem = /*#__PURE__*/React.forwardRef(
  ...
  React.createElement(ContextMenuPrimitive.RadioItem, _extends({
    ref: ref,
    className: cn(
      "relative flex cursor-default select-none items-center rounded-sm py-1.5 pl-8 pr-2 text-sm outline-none focus:bg-accent focus:text-accent-foreground data-[disabled]:pointer-events-none data-[disabled]:opacity-50",
      className
...
const ContextMenuLabel = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, inset, ...props }, ref) => /*#__PURE__*/
  React.createElement(ContextMenuPrimitive.Label, _extends({
    ref: ref,
    className: cn(
...
const ContextMenuSeparator = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, ...props }, ref) => /*#__PURE__*/
  React.createElement(ContextMenuPrimitive.Separator, _extends({
    ref: ref,
