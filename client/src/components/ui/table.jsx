...
const Table = /*#__PURE__*/React.forwardRef(
  ...
  React.createElement("div", { className: "relative w-full overflow-auto" }, /*#__PURE__*/
...
const TableHeader = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, ...props }, ref) => /*#__PURE__*/
  React.createElement("thead", _extends({ ref: ref, className: cn("[&_tr]:border-b", className) }, props))
);
