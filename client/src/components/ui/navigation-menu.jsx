...
const NavigationMenu = /*#__PURE__*/React.forwardRef(
  ...
  React.createElement(NavigationMenuPrimitive.Root, _extends({
    ref: ref,
    className: cn(
...
const NavigationMenuList = /*#__PURE__*/React.forwardRef(
  ...
  React.createElement(NavigationMenuPrimitive.List, _extends({
    ref: ref,
    className: cn(
...
const NavigationMenuTrigger = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, children, ...props }, ref) => /*#__PURE__*/
  React.createElement(NavigationMenuPrimitive.Trigger, _extends({
    ref: ref,
...
const NavigationMenuContent = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, ...props }, ref) => /*#__PURE__*/
  React.createElement(NavigationMenuPrimitive.Content, _extends({
    ref: ref,
    className: cn(
...
const NavigationMenuViewport = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, ...props }, ref) => /*#__PURE__*/
  React.createElement("div", { className: cn("absolute left-0 top-full flex justify-center") }, /*#__PURE__*/
  React.createElement(NavigationMenuPrimitive.Viewport, _extends({
    className: cn(
...
const NavigationMenuIndicator = /*#__PURE__*/React.forwardRef(
  ...
  ({ className, ...props }, ref) => /*#__PURE__*/
  React.createElement(NavigationMenuPrimitive.Indicator, _extends({
    ref: ref,
    className: cn(
