  ...
  return (/*#__PURE__*/
    React.createElement(DayPicker, _extends({
      ...
      components: {
        ...
        React.createElement(ChevronLeft, _extends({ className: cn("h-4 w-4", className) }, props)),

        IconRight: ({ className, ...props }) => /*#__PURE__*/
        React.createElement(ChevronRight, _extends({ className: cn("h-4 w-4", className) }, props))
